...
public class KhachHangUI extends JPanel {
    ...
    public KhachHangUI() {
        ...
        btnThem.addActionListener(e -> {
            ...
            kh.setGioiTinh(cbGioiTinh.getSelectedItem().toString().equals("Nam") ? 1 : 0);
            kh.setSdt(txtSDT.getText());
            kh.setCccd(txtCCCD.getText());

            if(new KhachHangDao().create(kh)){
...
// ===== RELOAD =====
    ...
    private boolean validData(){
        ...
        if(!ma.matches("^KH\\d{3}$")){
            JOptionPane.showMessageDialog(this, "Mã KH dạng KH001");
            return false;
        }
