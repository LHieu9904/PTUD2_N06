...
import Raven.event.EventTimeChange;
import Raven.event.EventTimePicker;
import Raven.event.EventTimeSelected;
...
public class TimePicker extends javax.swing.JPanel {
    ...
    private void initComponents(JFrame frame) {
        ...
        cmdAM = new TimePickerButton(frame,false);
        cmdPM = new TimePickerButton(frame,false);
        cmdHour = new TimePickerButton(frame,false);
        cmdMinute = new TimePickerButton(frame,false);
        cmdOK = new TimePickerButton(frame,true);
        cmdCancel = new TimePickerButton(frame,true);
        ...
        header.setBackground(new Color(37, 88, 207));
        ...
        lbSplit.setForeground(new Color(178, 178, 178));
        ...
        cmdAM.setBackground(new Color(37, 88, 207));
        cmdAM.setBorder(null);
        cmdAM.setForeground(new Color(255, 255, 255));
        cmdAM.setText("AM");
        cmdAM.setFont(new java.awt.Font("sansserif", 1, 15)); // NOI18N
        cmdAM.addActionListener(new ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmdAMActionPerformed(evt);
            }
        });

        cmdPM.setBackground(new Color(37, 88, 207));
        cmdPM.setBorder(null);
        cmdPM.setForeground(new Color(255, 255, 255));
        cmdPM.setText("PM");
        cmdPM.setFont(new java.awt.Font("sansserif", 1, 15)); // NOI18N
        cmdPM.addActionListener(new ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        cmdHour.setBackground(new Color(37, 88, 207));
        cmdHour.setForeground(new Color(255, 255, 255));
        cmdHour.setText("07");
        cmdHour.setFont(new java.awt.Font("sansserif", 0, 48)); // NOI18N
        cmdHour.addActionListener(new ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmdHourActionPerformed(evt);
            }
        });

        cmdMinute.setBackground(new Color(37, 88, 207));
        cmdMinute.setForeground(new Color(178, 178, 178));
        cmdMinute.setText("30");
        cmdMinute.setFont(new java.awt.Font("sansserif", 0, 48)); // NOI18N
        cmdMinute.addActionListener(new ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        cmdOK.setForeground(new Color(37, 88, 207));
        cmdOK.setText("OK");
        ...
        cmdCancel.setForeground(new Color(37, 88, 207));
        ...
        jCB24hour.addActionListener(new ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        timeComponent.setBackground(new Color(242, 242, 242));
    ...
    private TimePickerButton cmdAM;
    private TimePickerButton cmdCancel;
    private TimePickerButton cmdHour;
    private TimePickerButton cmdMinute;
    private TimePickerButton cmdOK;
    private TimePickerButton cmdPM;
    private javax.swing.JPanel header;
    private javax.swing.JCheckBox jCB24hour;
    private TimePickerLabel lbSplit;
